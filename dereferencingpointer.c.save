...
int main(void)
{
    ...
    printf("\n %p \n " , pGrades);
     ...
     printf("\n print out all the values in those memory addresses from pointer variables.\n");
    printf("\n %d \n " , *pAge);
    printf("\n %f \n " , *pGpa);
    printf("\n %f \n " , *pRoll);
    printf("\n %c \n " , *pGrade);
