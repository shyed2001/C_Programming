# C_Programming — Claude Instructions

Fleet-root `CLAUDE.md` is auto-loaded in every session under
`F:\GitHubDesktop\GitHubCloneFiles`. This file adds repo-local notes; it does not
replace it.
